...
{
    [TestFixture]
    public class EntityMemberMapperDateTimeShould
    {
        [SetUp]
        public void SetUp()
        {
        ...
        private EntityMemberMapperBuilder<MappingTestEntity, DateTime> AssumeBuilderIsInitialised(string Name)
        {
            var memberInfo = typeof(MappingTestEntity).GetMember(Name)[0];
            var builder = new EntityMemberMapperBuilder<MappingTestEntity, DateTime>(memberInfo);
            return builder;
        }
