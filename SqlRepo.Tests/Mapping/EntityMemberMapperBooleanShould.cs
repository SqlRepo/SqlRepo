...
{
    [TestFixture]
    public class EntityMemberMapperBooleanShould
    {
        [SetUp]
        public void SetUp()
        {
        ...
        private EntityMemberMapperBuilder<MappingTestEntity, bool> AssumeBuilderIsInitialised(string Name)
        {
            var memberInfo = typeof(MappingTestEntity).GetMember(Name)[0];
            var builder = new EntityMemberMapperBuilder<MappingTestEntity, bool>(memberInfo);
            return builder;
        }
