...
namespace SqlRepo.Tests
{
    ...
    public class EntityMemberMapperShortShould
    {
        ...
        private EntityMemberMapperBuilder<MappingTestEntity, short> AssumeBuilderIsInitialised(string Name)
        {
            var memberInfo = typeof(MappingTestEntity).GetMember(Name)[0];
            var builder = new EntityMemberMapperBuilder<MappingTestEntity, short>(memberInfo);
            return builder;
        }
