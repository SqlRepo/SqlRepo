...
namespace SqlRepo.Tests
{
    ...
    public class EntityMemberMapperLongShould
    {
        ...
        private EntityMemberMapperBuilder<MappingTestEntity, long> AssumeBuilderIsInitialised(string Name)
        {
            var memberInfo = typeof(MappingTestEntity).GetMember(Name)[0];
            var builder = new EntityMemberMapperBuilder<MappingTestEntity, long>(memberInfo);
            return builder;
        }
