...
namespace SqlRepo.Testing.NSubstitute
{
    public static class DeleteStatementSubstituteExtensions
    {
        ...
        public static IDeleteStatement<TEntity> ReceivedAndEquals<TEntity>(this IDeleteStatement<TEntity> deleteCommand,
            string property,
            string value) where TEntity: class, new()
        {
        ...
        public static IDeleteStatement<TEntity> ReceivedAndGreaterThan<TEntity>(this IDeleteStatement<TEntity> deleteCommand,
            string property,
            string value) where TEntity : class, new()
        {
            return deleteCommand.Received()
