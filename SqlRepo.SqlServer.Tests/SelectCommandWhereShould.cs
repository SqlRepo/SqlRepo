...
{
    [TestFixture]
    public class SelectCommandWhereShould : SelectCommandTestBase
    {
        [Test]
        public void ThrowErrorIfTableNotSpecifiedOnWhere()
        {
            ...
            this.Command.Invoking(c => c.Where(e => e.Id == 1, "a"))
                .ShouldThrow<InvalidOperationException>()
                .WithMessage(ExpectedMessage);
            this.Command.Invoking(c => c.Where<InnerEntity>(e => e.Id == 1, "a"))
                .ShouldThrow<InvalidOperationException>()
                .WithMessage(ExpectedMessage);
        }
        ...
        public void AddSpecificationOnWhere()
        {
            ...
            this.Command.Specification.Filters.Should()
                .NotBeNullOrEmpty();
        ...
        {
            this.Command.Invoking(c => c.And(e => e.IntProperty == 1))
                .ShouldThrow<InvalidOperationException>()
                .WithMessage(
        ...
        public void AddSpecificationOnWhereIn()
        {
            ...
            this.Command.WhereIn(e => e.Id, values);
            this.AssertFilterGroupIsValid(0, FilterGroupType.Where);
        ...
        public void AddSpecificationOnWhereBetween()
        {
            const int start = 1;
            const int end = 10;
            this.Command.WhereBetween(e => e.Id, start, end);
            this.AssertFilterGroupIsValid(0, FilterGroupType.Where);
        ...
        public void ThrowErrorIfNestingAttemptedWithoutWhere()
        {
            ...
            this.Command.Invoking(e => e.NestedAnd(e1 => e1.Id == 1)).ShouldThrow<InvalidOperationException>()
                .WithMessage(ExpectedMessage);
            this.Command.Invoking(e => e.NestedOr(e1 => e1.Id == 1)).ShouldThrow<InvalidOperationException>()
                .WithMessage(ExpectedMessage);
             this.Command.Invoking(e => e.NestedAndIn(e1 => e1.Id, new [] {1, 2, 3})).ShouldThrow<InvalidOperationException>()
                .WithMessage(ExpectedMessage);
             this.Command.Invoking(e => e.NestedOrIn(e1 => e1.Id, new [] {1, 2, 3})).ShouldThrow<InvalidOperationException>()
                .WithMessage(ExpectedMessage);
             this.Command.Invoking(e => e.NestedAndBetween(e1 => e1.Id, 5, 10)).ShouldThrow<InvalidOperationException>()
                .WithMessage(ExpectedMessage);
             this.Command.Invoking(e => e.NestedOrBetween(e1 => e1.Id, 5, 10)).ShouldThrow<InvalidOperationException>()
                .WithMessage(ExpectedMessage);
        }
        ...
        public void AddNewFilterGroupAndConditionOnNestedAnd()
        {
            ...
            var parent = this.Command.Specification.Filters[0];
        ...
        {
            var condition = this.Command.Specification.Filters[filterIndex].Conditions[conditionIndex];
        ...
        {
            var specification = this.Command.Specification.Filters[index];
